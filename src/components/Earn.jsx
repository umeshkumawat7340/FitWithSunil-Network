...
const tiers = [
  {
    ...
    title: 'Starter',
    commission: '15%',
    desc: 'Earn 15% on every product you directly sell to customers.',
    members: 0,
    color: '#cd7f32',
  },
  {
    ...
    commission: '25%',
    desc: 'Earn 25% on personal sales + 5% from your team\'s sales.',
    members: 5,
    color: '#adb5bd',
  },
  {
    ...
    title: 'Gold Leader',
    commission: '35%',
    desc: 'Earn 35% personal + 10% from team + 3% from extended network.',
    members: 20,
    color: '#f0b429',
  },
  {
    ...
    title: 'Diamond Elite',
    commission: '40%+',
    desc: 'Maximum earning potential. Unlimited levels, car allowance, travel perks.',
    members: 100,
    color: '#7dd3fc',
  },
]
